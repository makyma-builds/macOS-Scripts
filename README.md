...
B) It's just a bash script, and is not reliant on JumpCloud as an MDM. So long as you can have it run as root, should run easy peasy. \
C) This does quit Slack as part of the process, as otherwise Slack has a decent chance of freezing or crashing until it was able to quit and reopen. Keep this in mind when you deploy, and try to set it to run on user login or something like that. 
